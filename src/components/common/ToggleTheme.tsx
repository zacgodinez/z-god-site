...
export default function ToggleTheme() {
  ...
  return (
    <DropDown
      ...
      customTrigger={
        <button class="flex shrink-0 items-center gap-1 text-xs text-muted-foreground">
          <span class="underline decoration-1 underline-offset-4 outline-2 outline-offset-2 !outline-primary !transition-all hover:text-primary-action focus:outline-none focus-visible:outline">
            Theme
          </span>
