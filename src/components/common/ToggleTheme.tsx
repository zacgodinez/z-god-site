...
export default function ToggleTheme() {
  ...
  return (
    <DropDown
      ...
      customTrigger={
        <button class="focus-none flex shrink-0 cursor-pointer items-center gap-1 text-xs text-muted-foreground !transition-all hover:text-primary-action focus:outline-none">
