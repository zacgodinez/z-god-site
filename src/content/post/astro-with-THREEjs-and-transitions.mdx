...
You have probably seen with your eyeballs 👀, the demo's of Astro websites using native browser [page transitions](https://docs.astro.build/en/guides/view-transitions/).
You see them, and you want em'. <br />I get it, I want them too.

Load the memes and **let's go**.

<div class="zg-blog-image">
  ![Cage McCage let's go](~/assets/images/astro-with-THREEjs-and-transitions/cage-01.webp)
</div>

### Installing Astro

The Astro docs are great, use them [here](https://docs.astro.build/en/install-and-setup/) and follow along.
