...
date: "2023-07-21"
desc: "You know I need to glob stuffs, right?"
tags:
 - "qwik"
 - "typescript"
 - "web"
permalink: "/posts/blog-posts-in-qwik"
---
...
```ts title="src/utils/asyncmap.ts"
/**
...
```tsx {17,21} title="src/routes/posts/index.tsx"
// ... some code
...
export function searchPost(query: string, stack: Post[]) {
	...
	const searchVars = stack.map((result) => {
		const searchableObject = {
			...
			value: `${result.title} ${result.date} ${result.desc} ${result.tags.join(
				" "
			)}`.toLowerCase(),
		};
...
```tsx {3,5-6,21-24} title="src/routes/posts/index.tsx"
// ... some code
...
```tsx {10-19} title="src/routes/posts/index.tsx"
// ... some code
...
```tsx {12} title="src/routes/posts/index.tsx"
// ... some code
...
I guess that's it. I hope you find this article useful. If you have any questions, feel free to ask me on [Telegram](https://t.me/lapplund). I'll see you in the next article. Bye!
